    ...
    return (
      <Layout language={language}>
        ...
        <div className="container">
          <Link href="/[language]/settings" as={`/${language}/settings`}>
            ...
            <div id="wrapper">
                ...
                <div className="wrapper__weather" id="c2">
                    <img className="weather__img" src={ `/icons/weather/${weather.icon}.png`}/>
                    <p >
          ...
          {language == "fr" ? <p className="sub">Que cherchez vous ?</p> : null}
          {(language != "nl" && language != "fr") ? <p className="sub">What do you want to find?</p> : null}
