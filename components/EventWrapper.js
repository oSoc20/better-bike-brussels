    ...
    return (
      <div>
        <article className="todayview">
          ...
          {language == "fr" ? <h1 className="title__ongoing">Évènement(s) se déroulant aujourd'hui</h1> : null}
        ...
        <article className="futureview">
          ...
          {language == "fr" ? <h1 className="title__ongoing">Autres évènements à venir</h1> : null}
